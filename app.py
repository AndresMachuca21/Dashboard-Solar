    ...
    children=[
        ...
        html.Div([
            html.Div([
                ...
                html.P(id="kpi-sunnorte", style={"fontSize": "28px", "color": "#84B113", "marginTop": "5px", "right": "-50px"})
            ...
            html.Div([
                ...
                html.P(id="kpi-total", style={"fontSize": "28px", "color": "#000000", "marginTop": "5px", "left": "-50px"})
            ], style={"textAlign": "center", "flex": "1"}),
